...
def main():
    ...
    parser.add_argument("--label-config", default="data/annotation/config/label_config.xml", help="Path to label config XML")
    parser.add_argument("--output", default="data/annotation/config/project_bootstrap.json", help="Where to write project creation payload")
    ...
    print(r"curl -X POST http://localhost:8080/api/projects -H \"Authorization: Token <API_KEY>\" -H \"Content-Type: application/json\" --data @data/annotation/config/project_bootstrap.json")
