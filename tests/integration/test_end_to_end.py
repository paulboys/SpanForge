...
class TestEndToEndPipeline(IntegrationTestBase):
    ...
    def test_jsonl_persistence_stage(self):
        ...
        texts = ["Patient has headache and nausea.", "Applied cream, experienced rash."]
    ...
    def test_pipeline_preserves_provenance(self):
        ...
        gold_record = {
            ...
            "annotator": "system",
            "revision": 1,
            "metadata": {"fuzzy_threshold": 0.88, "jaccard_threshold": 40},
        }
...
class TestMultiDocumentProcessing(IntegrationTestBase):
    ...
    def test_batch_weak_labeling(self):
        ...
        texts = [f"Patient {i} reports headache after aspirin." for i in range(10)]
    ...
    def test_consistent_span_detection_across_similar_texts(self):
        ...
        spans_results = [
            weak_label(t, self.symptom_lexicon, self.product_lexicon) for t in variations
        ]
        ...
        for spans in spans_results:
            ...
            self.assertIn("Headache", symptom_canonicals, "All variations should detect headache")
            self.assertIn("Rash", symptom_canonicals, "All variations should detect rash")
...
class TestPipelineWithLLMStub(IntegrationTestBase):
    ...
    def test_llm_refinement_stage_stub(self):
        ...
        self.assertEqual(len(final_spans), len(spans), "Stub should not add suggestions")
